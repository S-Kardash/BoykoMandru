...
//     var selectTrigger = customSelect.querySelector('.select-trigger');
//     var selectOptions = document.querySelectorAll('.select-options li');

//     // Ініціалізація i18next
//     i18next.init({
//         lng: getSavedLanguage() || 'Ua', // Зчитати мову збережену користувачем, або встановити за замовчуванням 'uk'
//         resources: {
//             Eng: {
//                 translation: {
//                     routes: 'Routes',
//                     services: 'Services',
//                     contacts: 'Contacts'
//                     // Додайте інші переклади для англійської мови
//                 }
//             },
//             Ua: {
//                 translation: {
...
//                     services: 'Послуги',
//                     contacts: 'Контакти'
//                     // Додайте інші переклади для української мови
//                 }
//             }
//         }
//     });

//     // Перевірка, чи потрібно оновити дані
//     if (shouldUpdateData()) {
//         // Викликати функцію для оновлення текстового контенту та очищення localStorage
//         updateContent();
//         clearLocalStorage();
//     } else {
//         // Встановлення обраних налаштувань мови при завантаженні сторінки
//         updateContent();
//         updateSelectTrigger();
//     }
...
//             // Викликати функцію для зміни мови за допомогою i18next
//             changeLanguage(value);
//         });
//     });

//     // Функція для зміни мови за допомогою i18next
//     function changeLanguage(language) {
//         i18next.changeLanguage(language, function (err, t) {
//             // Викликати функцію для оновлення текстового контенту на всій сторінці
//             updateContent();
//             updateSelectTrigger();
//         });
//     }

//     // Функція для оновлення текстового контенту на всій сторінці
//     function updateContent() {
//         // Оновлюємо текст в блоках навігації
...
//         selectTrigger.textContent = i18next.t(getSavedLanguage() || 'Ua');
//     }
...
//     // Зчитати збережену мову з localStorage
//     function getSavedLanguage() {
//         return localStorage.getItem('selectedLanguage');
//     }

//     // Функція для перевірки, чи потрібно оновити дані
//     function shouldUpdateData() {
//         var lastUpdate = localStorage.getItem('lastUpdate');
//         if (!lastUpdate) {
//             // Якщо дата останнього оновлення відсутня, оновити дані
//             return true;
//         }
//         var currentTime = new Date().getTime();
//         var timeDiff = currentTime - lastUpdate;
//         var hoursSinceLastUpdate = timeDiff / (1000 * 60 * 60);
//         // Перевірка, чи пройшло більше 24 годин
